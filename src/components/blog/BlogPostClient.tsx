...
export default function BlogPostClient({ initialPost, slug }: BlogPostClientProps) {
  ...
  useEffect(() => {
    // If we already have the initial post data from SSR, skip client-side fetching
    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-3xl">
        <Button asChild variant="outline" className="mb-6">
          <Link href="/blog" className="inline-flex items-center mb-8 text-[#E98A23] hover:underline">
