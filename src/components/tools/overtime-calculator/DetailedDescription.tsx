        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              ...
              <li>Specify regular hours before overtime (typically 40 hours/week)</li>
              <li>Set standard hours for your pay period</li>
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-gray-700">
              ...
              It then applies the overtime multiplier to hours worked beyond your regular hours.
            </p>
            <div className="space-y-2">
              <h3 className="font-semibold">Key Terms:</h3>
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>Regular Hours: Standard working hours before overtime applies</li>
                <li>Overtime Hours: Hours worked beyond regular hours</li>
