    ...
    <div className="py-8 bg-gray-50">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold mb-2">1. Determine Airflow Requirements</h3>
