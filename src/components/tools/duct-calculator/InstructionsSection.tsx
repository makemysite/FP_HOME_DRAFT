      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            <div className="font-semibold min-w-[120px]">1. Input Data:</div>
            <div>Enter key details like airflow rate, duct shape, and dimensions.</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold min-w-[120px]">2. Calculate:</div>
            <div>Hit the "Calculate" button, and the tool will instantly give you your results.</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold min-w-[120px]">3. Review Results:</div>
            <div>See the required duct size, airflow velocity, and friction loss.</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold min-w-[120px]">4. Adjust & Reset:</div>
