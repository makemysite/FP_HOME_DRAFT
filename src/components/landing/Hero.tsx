  ...
  return (
    <section className="w-full max-w-[1334px] max-md:max-w-full mt-[52px]">
      <div className="w-full flex flex-col">
        ...
        <div className="shadow-[0px_3px_14px_0px_rgba(74,58,255,0.03),0px_-2px_4px_0px_rgba(20,20,43,0.02),0px_12px_24px_0px_rgba(20,20,43,0.04)] bg-white flex w-full items-center justify-start gap-[20px] px-6 py-4 rounded-[18px] max-md:flex-col max-md:items-start">
          <div className="text-[rgba(7,15,24,1)] text-base font-semibold text-left mr-10 max-md:w-full max-md:mb-4">
            Trusted by
            <br />
            Our Clients
          </div>
          <div className="flex-1 flex items-center justify-start gap-[20px] max-md:flex-col max-md:w-full">
            <img
