  ...
  return (
    <nav className="flex items-center gap-[40px_100px] text-center flex-wrap max-md:max-w-full">
      ...
      <div className="self-stretch flex min-w-60 items-center gap-[40px_65px] text-base text-black font-normal whitespace-nowrap flex-wrap my-auto max-md:max-w-full">
        <Link to="/" className="text-[rgba(18,20,22,1)] self-stretch my-auto hover:text-[rgba(233,138,35,1)] transition-colors">
          Home
        </Link>
        <Link to="/features" className="self-stretch my-auto hover:text-[rgba(233,138,35,1)] transition-colors">
          Features
        </Link>
        <Link to="/pricing" className="text-[rgba(233,138,35,1)] font-semibold self-stretch my-auto hover:text-[rgba(233,138,35,1)] transition-colors">
          Pricing
        </Link>
        <Link to="/industries" className="self-stretch my-auto hover:text-[rgba(233,138,35,1)] transition-colors">
          Industries
        </Link>
        <Link to="/blog" className="self-stretch my-auto hover:text-[rgba(233,138,35,1)] transition-colors">
          Blogs
        </Link>
      </div>
